...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/LordMudaID/wabot)
...
git clone https://github.com/LordMudaID/wabot
cd wabot-aq
npm install
npm update
```
